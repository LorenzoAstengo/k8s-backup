...
declare -a personalParams=("annotations" "revision" "last-applied-configuration" "creationTimestamp" "generation" "resourceVersion" "selfLink" "uid" "progressDeadlineSeconds" "{\"apiVersion")
